...
export default async function Home({
  ...
  // Pantalla de pasajero: un conductor que caiga acá se va a su panel.
  const user = await requirePassenger('/buscar');
  ...
  return (
    <>
      ...
      <main className="screen" id="contenido">
        ...
        <div className="greet">
          <h1 className="greet-title">
            {user.name.split(' ')[0]}, ¿para dónde vas?
          </h1>
      ...
      <BottomNav current="buscar" user={user} />
    </>
  );
}
